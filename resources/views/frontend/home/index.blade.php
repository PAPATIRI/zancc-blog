...
@section('content')
    ...
    <header class="bg-transparent border-bottom mb-4 py-4">
        <div class="container">
            <div class="text-center my-2" data-aos="zoom-in" data-aos-delay="50">
                <h1 class="fw-bolder fs-1 font-title">Welcome to my personal blog <span
                            class="custom-animation">👋</span></h1>
                <p class="lead fs-4 mb-0 mt-1 mt-md-3 mt-lg-3 font-paragraph">Ilmu adalah buruan dan tulisan adalah
                    ikatannya, maka
                    ikatlah
                    buruanmu dengan tali yang kuat</p>
                <p class="fw-light fs-6 mt-2 font-paragraph">~Imam Syafi'i~</p>
            </div>
        </div>
    </header>
    <!-- Page content-->
            ...
            <div class="col-lg-8">
                <div class="d-flex gap-3 flex-wrap justify-content-center">
                    @forelse($articles as $article)
                        <!-- Blog post-->
                        <div class="card shadow font-paragraph" style="width: 350px" data-aos="zoom-in-up"
